...
function siteorigin_panels_lite_localization( $key = false ){
	...
	if( empty($loc) ) {
		$loc = apply_filters( 'siteorigin_panels_lite_localization', array(
			'page_builder' => __( 'Page Builder', 'influence' ),
			'home_page_title' => __( 'Custom Home Page Builder', 'influence' ),
			'home_page_menu' => __( 'Home Page', 'influence' ),
			'install_plugin' => __( 'Install Page Builder Plugin', 'influence' ),
			'on_text' => __( 'On', 'influence' ),
			'off_text' => __( 'Off', 'influence' ),

			// Longer message to display to a user about installing the plugin
			'home_install_message' => __( 'This theme supports Page Builder to create beautifully proportioned column based content.', 'influence' ),
